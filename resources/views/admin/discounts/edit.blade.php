    ...
    <form action="{{ route('admin.discounts.update', $discount->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="discount_type" class="form-control" required>
                ...
                <option value="amount" {{ $discount->discount_type == 'amount' ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="max_discount_value" class="form-control" value="{{ $discount->max_discount_value }}">
        </div>
