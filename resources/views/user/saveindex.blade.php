            ...
            <div class="row g-4 justify-content-center">
                     ...
                     <div class="product-card2">
                        ...
                        <div class="product-card-img">
                           ...
                           <div class="cart-btn-area">
                               <div class="cart-btn">
                                   <a href="product-default.html" class="add-cart-btn2 round hover-btn5">Select options</a>
                               </div>
                           </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="product-card2">
                        ...
                        <div class="product-card-content">
                            ...
                            <h6><a href="product-default.html" class="hover-underline">Prism Eyeshadow Palette</a></h6>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="product-card2">
                        ...
                        <div class="product-card-content">
                            ...
                            <h6><a href="product-default.html" class="hover-underline">Hydrating Red Lip Stain.</a></h6>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="product-card2">
                        ...
                        <div class="product-card-img">
                           ...
                           <div class="cart-btn-area">
                               <div class="cart-btn two">
                                   <a href="out-of-stock.html" class="add-cart-btn2 round hover-btn5">Request Stock</a>
                               </div>
                           </div>
                           <div class="view-and-favorite-area">
                                <ul>
                        ...
                        <div class="product-card-content">
                            ...
                            <h6><a href="product-default.html" class="hover-underline">Brightening Serum cream</a></h6>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="product-card2">
                        ...
                        <div class="product-card-content">
                            ...
                            <h6><a href="product-default.html" class="hover-underline">Hydrating Lip Gloss pack</a></h6>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="product-card2">
                        ...
                        <div class="product-card-content">
                            ...
                            <h6><a href="product-default.html" class="hover-underline">Salt Spray Beachy Waves</a></h6>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="product-card2">
                        ...
                        <div class="product-card-content">
                            ...
                            <h6><a href="product-default.html" class="hover-underline">Necessaire the deodorant</a></h6>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                     <div class="product-card2">
                        ...
                        <div class="product-card-content">
                            <p><a href="shop-list.html">Luxe Lashes</a></p>
                            <h6><a href="product-default.html" class="hover-underline">Makeup Smooth brushes</a></h6>
                ...
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="sg-accessories-tab" data-bs-toggle="pill" data-bs-target="#sg-accessories"
                            type="button" role="tab" aria-controls="sg-accessories" aria-selected="false">Accessories</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="sg-care-tab" data-bs-toggle="pill" data-bs-target="#sg-care" type="button"
                            role="tab" aria-controls="sg-care" aria-selected="false">Personal Care</button>
                    </li>
                </ul>
            </div>
                               ...
                               <div class="cart-btn">
                                   <a href="cart.html" class="add-cart-btn2 round hover-btn5"><i class="bi bi-bag-check"></i> Add To Cart</a>
                                    ...
                                    <div class="product-card-content">
                                        ...
                                        <h6><a href="product-default.html" class="hover-underline">Brightening Vitamin</a></h6>
                               ...
                               <div class="cart-btn">
                                   <a href="cart.html" class="add-cart-btn2 round hover-btn5"><i class="bi bi-bag-check"></i> Add To Cart</a>
                                    ...
                                    <div class="product-card-content">
                                        ...
                                        <h6><a href="product-default.html" class="hover-underline">Shimmering Eyeshadow</a></h6>
                               ...
                               <div class="cart-btn">
                                   <a href="cart.html" class="add-cart-btn2 round hover-btn5"><i class="bi bi-bag-check"></i> Add To Cart</a>
                                    ...
                                    <div class="product-card-content">
                                        ...
                                        <h6><a href="product-default.html" class="hover-underline">Skin Clarifying Cleanser</a></h6>
                            ...
                            <div class="swiper-slide">
                                <div class="product-card2">
                                    ...
                                    <div class="product-card-content">
                                        ...
                                        <h6><a href="product-default.html" class="hover-underline">Volume Boosting Mascara</a></h6>
                            ...
                            <div class="swiper-slide">
                               ...
                               <div class="cart-btn">
                                   <a href="cart.html" class="add-cart-btn2 round hover-btn5"><i class="bi bi-bag-check"></i> Add To Cart</a>
                                    ...
                                    <div class="product-card-content">
                                        <p><a href="shop-list.html">Crystal Gleam</a></p>
                                        <h6><a href="product-default.html" class="hover-underline">Crystal-Infused Highlighter</a>
                                        </h6>
                                        <span>$150.00 <del>$200.00</del></span>
                                        <div class="rating">
                                            <ul>
